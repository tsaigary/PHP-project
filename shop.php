                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <div class="product-overlay">
                                                <ul class="mb-0 list-inline">
                                                    ...
                                                    <li class="list-inline-item m-0 p-0">
                                                        <a class="btn btn-sm btn-dark" href="addCart.php">
                                                            <form name="cartForm" id="cartForm" method="POST" action="./addCart.php">
                                                                <input type="hidden" name="cartQty" id="cartQty" value="1" maxlength="5">
                                                                <button hidden type="button" class="" id="btn_addCart" data-item-id="<?php echo $_GET['itemId'] ?>">Add to cart</button>
