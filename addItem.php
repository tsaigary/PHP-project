            ...
            <section class="py-5 bg-light">
                <div class="container">
                    <div class="row px-4 px-lg-5 py-lg-4 align-items-center">
                        <div class="col-lg-6">
                            <h1 class="h2 text-uppercase mb-0">Create Item</h1>
                        </div>
                        ...
                        <form name="myForm" method="POST" action="./insert.php" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input class="form-control form-control-lg" id="eventName" name="itemName" type="text" placeholder="輸入名稱">
                                </div>
                                <div class="col-lg-6 form-group">
                                ...
                                <div class="col-lg-12 form-group">
                                    <label class="text-small text-uppercase" for="address">商品售價</label>
